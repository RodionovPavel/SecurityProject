INSERT INTO question15 VALUES ('97b77788-2e17-4035-bb21-53e78f98051a', 1, 'Конструкторы', 'Какое значение по умолчанию имеет переменная типа short?
...
INSERT INTO question15 VALUES ('be6ecd5b-e967-4d3b-9c4f-e54594fcfd29', 1, 'Методы', 'Какой тип данных возвращает readLine()?
...
INSERT INTO question15 VALUES ('857ecf33-85f0-4de8-b525-57c9ecb49564', 1, 'Методы', 'Что будет выведено в консоль в результате выполнения следующего кода:
                                                                                     <pre>
                                                                                     int []a = {1,2,3,4,5,6};
                                                                                     int i = a.length - 1;
                                                                                     while(i>=0){
...
INSERT INTO question15 VALUES ('e1e0b096-d2bc-4825-b9e0-b3509a8fbae9', 1, 'Методы', 'Что будет выведено в консоль в результате выполнения следующего кода:
                                                                                     <pre>
                                                                                     class Ex6{
...
INSERT INTO question15 VALUES ('7225e32d-887e-4384-b644-7a86b8d20d04', 1, 'Методы', 'Что произойдет в результате выполнения данного фрагмента:
                                                                                     <pre>
